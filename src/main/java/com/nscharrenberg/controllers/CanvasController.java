...
public class CanvasController {
    ...
    private void initToolsMenu() {
        ...
        System.out.println(App.factory.getAppRepository().getBorderPane().getRight());
        ...
        App.factory.getCanvasRepository().getSidebarMenuDrawer().setOnDrawerClosed(e -> System.out.println("Closed"));
        App.factory.getCanvasRepository().getSidebarMenuDrawer().setOnDrawerOpened(e -> System.out.println("Opened"));
    }
