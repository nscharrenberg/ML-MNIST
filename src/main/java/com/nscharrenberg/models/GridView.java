...
import com.nscharrenberg.utils.MathLib;
...
public class GridView<State> extends StackPane {
    ...
    private void initMajorGuidelinesBindings(){
        numberOfHorizontalMajorGuidelines = MathLib.divideSafe(getGridModel().numberOfRows().subtract(1), horizontalGuidelineUnit);
        ...
        numberOfVerticalMajorGuidelines = MathLib.divideSafe(getGridModel().numberOfColumns().subtract(1), verticalGuidelineUnit);
    ...
    /**
     * This method initialized the filters that are needed for the mouse over click handler of the cell
     *
     *
     * @param pane
     * @param cell
